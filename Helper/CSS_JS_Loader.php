...
trait CSS_JS_Loader {
    ...
    public function admin_css() {
        ...
        wp_enqueue_style('oxilab-plugins-bootstrap', OXI_TABS_URL . 'assets/backend/css/bootstrap.min.css', false, OXI_TABS_PLUGIN_VERSION);
    ...
    public function admin_elements_frontend_loader() {
        ...
        wp_enqueue_script('oxilab_plugins-editor', OXI_TABS_URL . 'assets/backend/custom/editor.js', false, OXI_TABS_PLUGIN_VERSION);
    ...
    public function admin_media_scripts() {
        wp_enqueue_media();
        wp_register_script('oxilab_plugins_media_scripts', OXI_TABS_URL . '/assets/backend/custom/media-uploader.js', false, OXI_TABS_PLUGIN_VERSION);
        wp_enqueue_script('oxilab_plugins_media_scripts');
    }
    ...
    public function import_font_family() {
        ...
        if (apply_filters('oxilab_plugins-plugin/pro_version', false) == false):
